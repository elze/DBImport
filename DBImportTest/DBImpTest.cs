...
namespace DBImportTest
{
    ...
    public class DBImpTest
    {
        ...
        public void compactifyReferringURLShouldReturnCompactString()
        {
            ...
            Assert.AreEqual("... http://gallery.geekitude.com/v/2007/2007Cruise/mayanRuins/CIMG8257BeheadedPlayerBlood.jpg ", strCompact1url);
            ...
            Assert.AreEqual("... p=kligong women ... p=kligong women ... rw=klingon women ... pic.geekitude.com/d/5943-2/P1020516KlingonWomen.jpg ... http://pic.geekitude.com/v/sf/fencon2008/fencos2008/P1020516KlingonWomen.jpg ", strCompact3p);
